    ...
    return (
      <View behavior="padding" style={styles.container}>
        <Header backgroundColor='white'
          ...
          leftComponent={{ icon: 'arrow-left', color: 'black', type: 'material-community', size: 28, }}
        ...
        <Input
          ...
          errorMessage={this.state.errorCompany? "Cannot leave blank": ""}
        ...
        <Input
          ...
          placeholder='$10.00'
          errorMessage={this.state.errorAmount? "Cannot leave blank": ""}
